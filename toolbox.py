...
# TODO: Look and implement label modes for different algorithms
# TODO: Write object types on doc strings
...
def changeImage(camera, newImgName, oldImg, pathToBackgroundImages):
    ...
    '''
    cameraConstant = 2.1892349261 #Based on the camera angle(if field of view changes this must also change) # TODO: get this via code.
    deselectAll()
...
#Update this to get them from the conf file.
def loadImages(backgroundImagesPath):
    picList = os.listdir(backgroundImagesPath)
    jpgList = [item for item in picList if item[-3:] == 'jpg'] #TODO: add other kinds of images
    return picList
...
def generateLabelXmlFile(object, scene, camera, pathToResults, img, resX, resY, Objectlabel):
    '''
...
def generateLabelTextFile(object, scene, camera, pathToResults, img, resX, resY, Objectlabel):
    '''
